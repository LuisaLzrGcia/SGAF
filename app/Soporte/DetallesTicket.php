<div class="modal fade" id="detallesTicket" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="numeroT" name="numeroT" disabled readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="solucionT" name="solucionT" rows="3" disabled
                        readonly></textarea>
                </div>
                <div class="mb-3">
                    <label for="fechaCreacionT" class="form-label">Fecha creación</label>
                    <input type="text" class="form-control" id="fechaCreacionT" name="fechaCreacionT" disabled readonly>
                </div>
                <div class="mb-3">
