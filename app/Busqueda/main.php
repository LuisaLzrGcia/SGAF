                ...
                if ($file != '.' && $file != '..') {
                    ...
                    if (is_dir($filePath)) {
                        ...
                        if (strpos($file, $searchTerm) !== false) {
                            $matchingFiles[] = $file; // Guardamos solo el nombre del archivo
                        }
                    }
                }
            }
        ...
        if (isset($_POST['search'])) {
            ...
            if (count($matchingFiles) > 0) {
                ...
                foreach ($matchingFiles as $file) {
                    $filePath = realpath($_SESSION['url'] . '/' . $file); // Obtiene la ruta absoluta del archivo
                    echo "<div class='direccionFile'>";
                    echo "Dirección real del archivo: " . $filePath;
                    echo "<a class='nombreFile w-100 ms-3' href='descargarArchivo.php?file=" . urlencode($filePath) . "' target='_blank'>";
